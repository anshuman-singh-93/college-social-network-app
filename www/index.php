...
<a class="item" href="LostAndFound.php" >
		LostAndFound
		</a>
...
Webmail
	...
	<div class="pusher">
<div class="ui inverted attached segment" style="background-image:url(image/f2.jpg); background-size: cover" >
...
<div class="ui secondary   menu">
  <a class="active item" style="color: white; font-size: medium">
    <i class="home icon" style="color:white"></i> Home
  </a>
...
<!-- close model of upload -->
	 ...
	 <div class="ui horizontal segment" style="padding:0px 0px" >
	
     	  <h1 class="ui header" style="color:blue; font-size: 50px; font-family: georgia; text-align:center; position:relative; left:17px;">TU~NUGGETS</h1>
		  <h3 style="color:red; text-align:center; position:relative; left:17px; padding:0%">Join the exclusive network of TEZPUR UNIVERSITY and Become a part of the family!<br>Sign up and express your <i class="heart icon"></i>out!
Discover the essence of TU. </h3>
    </div>
     ...
     <div class="ui vertical segment" style="height:387px; background-image:url(image/c7.jpg); background-size: cover;">
	 	  <h3 class="ui header" style=" font-size:30px;text-align:center">New Faces</h1>
		    <div id="polaroid" style="width:100%;"> <!--place the everything inside a div and give it an id or class for styling-->

		  <?php
		 $q="SELECT *  FROM user ORDER BY u_id DESC LIMIT 6";
		  $r=mysqli_query($con,$q);
...
<div class="ui  vertical segment" style="position:relative; top:50px;">
	...
	<div class='ui compact red inverted segment'style='position:relative;top:-30px;font-size:20px; margin:0 auto'>You Must Log In To Connect With Our Network</div>
<?php
}
