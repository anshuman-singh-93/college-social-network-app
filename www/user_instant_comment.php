...
$f_name=$row['f_name'];
		$l_name=$row['l_name'];
$com="SELECT * FROM wall_comment WHERE wall_id='$wall_id' AND u_id='$u_id' ORDER BY date DESC LIMIT 1";
...
$qz="SELECT * FROM  user WHERE u_id='$who_commented'";
$rz=mysqli_query($con,$qz);
