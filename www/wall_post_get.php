...
$fetch="SELECT * FROM user_wall WHERE u_id='$u_id' ORDER BY date DESC LIMIT 2 ";
...
$q="SELECT id FROM wall_like WHERE wall_id='$wall_id' AND u_id='$u_id' AND who_liked='$u_id'";
$r=mysqli_query($con,$q);
...
<div class="ui feed" >
 <div class="event">
    ...
    <div class="content">
      <div class="summary">
 <?php  
	 echo "<a class='author' href='userprofile.php?handle=".$c_user_name."'".">"."$f_name"." "."$l_name"."</a>"." "."Posted on wall";
	 ?>        <div class="date">
          <?php  echo"$date"?>
        </div>
      </div>
	  ...
	  {
	  ?>
         <a class=' active like <?php echo"$wall_id"."$u_id"?>' wall_id="<?php echo"$wall_id"?>" u_id="<?php echo"$u_id"?>" who_id="<?php  echo"$live_like_user"?>"  >
		...
		<?php
		  ...
		  {
		  ?>
		     <a class='like <?php echo"$wall_id"."$u_id"?>' wall_id="<?php echo"$wall_id"?>" u_id="<?php echo"$u_id"?>" who_id="<?php  echo"$live_like_user"?>"  >
          <i class="like icon"></i><?php echo"$like_count"?> Likes
        </a>
    <?php 
	}
...
$com="SELECT * FROM wall_comment WHERE wall_id='$wall_id' AND u_id='$u_id'";
...
//close comment
  ...
  <form class="ui reply form <?php  echo"$wall_id"?>">
    ...
    <div class="ui blue labeled submit icon button <?php  echo"$wall_id" ?>"   wall_id="<?php  echo"$wall_id"?>"  >
...
<div class="ui feed" >
 <div class="event">
    ...
    <div class="content">
      <div class="summary">
 <?php  
	 echo "<a class='author' href='userprofile.php?handle="."$c_user_name"."'".">"."$c_f_name"." "."$c_l_name"."</a>"." "."Posted on wall";
	 ?>        <div class="date">
          <?php  echo"$date"?>
        </div>
      </div>
...
if(cmnt!="")
{
      ...
      $('.ui.blue.labeled.submit.icon.button.'+wall_id).addClass("loading");
            ...
            data: 'cmnt='+cmnt+'&wall_id='+wall_id+'&u_id='+u_id,
            url:"comment.php",
