...
<!-- close model of upload -->
  ...
  <div class="ui error message">
	...
	<div class="ui right floated segment"  style="display:none; width:78%; height:570px; position:relative; top:-14px; overflow-y:scroll;" id="s_container">
		   <div id="polaroid" style="width:100%;" class="search_result"> <!--place the everything inside a div and give it an id or class for styling-->
		  </div> <!--end polaroid-->
